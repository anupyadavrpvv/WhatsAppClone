...
import com.neatroots.whatsapp.databinding.ActivityLogInBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.logInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //if email box or password box is empty then show error
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(LogInActivity.this, MainActivity.class);
                            startActivity(intent);
                            Toast.makeText(LogInActivity.this, "Signing in with Google account", Toast.LENGTH_SHORT).show();
